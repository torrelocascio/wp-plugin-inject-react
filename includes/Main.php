...
*
* @link       https://github.com/torrelocascio
* @since      1.0.0
*
* @package    plugin-name
...
class Plugin_Name {
    ...
    */
    private function define_admin_asset_hooks() {
        ...
        //This Loads the Admin Facing React App
        // $this->loader->add_action( 'admin_enqueue_scripts', $admin_assets, 'enqueue_admin_app_scripts' );
    ...
    */
    private function define_public_asset_hooks() {
        ...
        //This Loads the Public Facing React App
        $this->loader->add_action( 'wp_enqueue_scripts', $public_assets, 'enqueue_public_app_scripts' );
